...
def unique_chars_algorithmic(string):
...
def unique_chars_pythonic(string):
    return len(set(string)) == len(string)


def unique_bit_vector(string):
...
def unique_chars_using_dictionary(string: str) -> bool:
    character_counts = {}
    for char in string:
...
# runs in O(NlogN)
def unique_chars_sorting(string: str) -> bool:
...
class Test(unittest.TestCase):
    ...
    test_functions = [
        unique_chars_pythonic,
        unique_chars_algorithmic,
        unique_bit_vector,
        unique_chars_using_dictionary,
        unique_chars_sorting,
    ]
